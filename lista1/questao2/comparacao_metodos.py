...
visualizar_metodo("\N{TAB}Bissecao:      ", metodos.bissecao(funcao, tolerancia, 2, 3))
visualizar_metodo("\N{TAB}Falsa Posicao: ", metodos.falsa_posicao(funcao, tolerancia, 2, 3))
visualizar_metodo("\N{TAB}MNR:           ", metodos.newton(funcao, derivada_funcao, tolerancia, 1))
visualizar_metodo("\N{TAB}Secante:       ", metodos.secante(funcao, 2, 3, tolerancia))
